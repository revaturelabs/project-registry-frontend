...
export class CreateProjectComponent implements OnInit {
  public newProject: Project = new Project(0, "", new Status(1, "IN_ITERATION", ""), "", new User(1, "william", new Role(1, "admin")), [], new Phase(1, "BACKLOG_GENERATED", "CoE has completed the iterations backlog, awaiting trainer approval"));
